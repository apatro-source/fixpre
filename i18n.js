...
const I18N_ROWS = [
  ...
  ["ℹ️ Konum & KVKK aydınlatması (personele gösterilir)", "ℹ️ Location & privacy notice (shown to staff)", "ℹ️ Standort- & Datenschutzhinweis (für Personal)", "ℹ️ Уведомление о геолокации (для персонала)", "ℹ️ Aviso de ubicación y privacidad (para el personal)", "ℹ️ Informativa posizione e privacy (per il personale)"],
  ["Bu özelliği kullanırken personelinizi bilgilendirin; dilerseniz şirket adı/iletişiminizi ekleyin.", "When using this feature, inform your staff; you may add your company name/contact.", "Informieren Sie bei Nutzung dieser Funktion Ihr Personal; Sie können Firmenname/Kontakt hinzufügen.", "При использовании этой функции уведомите персонал; можно добавить название/контакты компании.", "Al usar esta función, informe a su personal; puede añadir el nombre/contacto de su empresa.", "Quando usi questa funzione, informa il personale; puoi aggiungere nome/contatto dell'azienda."],
  ["Mesai Saati", "Time clock", "Arbeitszeit", "Учёт времени", "Fichaje", "Orario di lavoro"],
  ["Mesai Kayıtları", "Time clock records", "Arbeitszeit-Einträge", "Записи учёта времени", "Registros de fichaje", "Registri orari"],
  ["Şu an mesaide", "Currently on shift", "Aktuell im Dienst", "Сейчас на смене", "Ahora en turno", "Ora in turno"],
  ["Giriş saati", "Clock in", "Einstempeln", "Приход", "Entrada", "Entrata"],
  ["Çıkış saati", "Clock out", "Ausstempeln", "Уход", "Salida", "Uscita"],
  ["Süre", "Duration", "Dauer", "Длительность", "Duración", "Durata"],
  ["Bu aralıkta mesai kaydı yok.", "No clock records in this range.", "Keine Einträge in diesem Zeitraum.", "Нет записей за этот период.", "Sin registros en este rango.", "Nessun record in questo intervallo."],
  ["⏱️ Mesai Saati Takibi (giriş-çıkış)", "⏱️ Time clock (clock in/out)", "⏱️ Arbeitszeiterfassung (Ein-/Ausstempeln)", "⏱️ Учёт времени (приход/уход)", "⏱️ Fichaje (entrada/salida)", "⏱️ Timbratura (entrata/uscita)"],
  ["Mesai saati takibini aç", "Enable time clock", "Arbeitszeiterfassung aktivieren", "Включить учёт времени", "Activar fichaje", "Attiva timbratura"],
  ["Konum zorunlu (mekâna yakın olunmalı)", "Require location (must be near the venue)", "Standort erforderlich (muss in der Nähe sein)", "Требовать локацию (быть рядом с местом)", "Ubicación obligatoria (cerca del local)", "Posizione obbligatoria (vicino alla sede)"],
  ["Konum zorunluysa her lokasyonun konumunu \"Lokasyonlar\"dan \"📍 Konumu ayarla\" ile kaydedin.", "If location is required, save each venue's location from \"Locations\" using \"📍 Set location\".", "Wenn Standort erforderlich ist, speichern Sie den Standort jeder Filiale unter \"Standorte\" mit \"📍 Standort festlegen\".", "Если локация обязательна, сохраните координаты каждого места в разделе \"Локации\" кнопкой \"📍 Задать локацию\".", "Si la ubicación es obligatoria, guarde la ubicación de cada local desde \"Locales\" con \"📍 Definir ubicación\".", "Se la posizione è obbligatoria, salva la posizione di ogni sede da \"Sedi\" con \"📍 Imposta posizione\"."],
  ["📍 Konumu ayarla", "📍 Set location", "📍 Standort festlegen", "📍 Задать локацию", "📍 Definir ubicación", "📍 Imposta posizione"],
  ["📍 Konum ✓", "📍 Location ✓", "📍 Standort ✓", "📍 Локация ✓", "📍 Ubicación ✓", "📍 Posizione ✓"],
  ["Konum gerekli ama cihaz GPS desteklemiyor.", "Location is required but this device doesn't support GPS.", "Standort erforderlich, aber dieses Gerät unterstützt kein GPS.", "Требуется геолокация, но устройство не поддерживает GPS.", "Se requiere ubicación, pero este dispositivo no admite GPS.", "Posizione richiesta, ma questo dispositivo non supporta il GPS."],
  ["Mekâna yakın değilsiniz. Mesaiye mekânda başlayın.", "You're not near the venue. Clock in at the venue.", "Sie sind nicht am Standort. Stempeln Sie am Standort ein.", "Вы не рядом с местом. Отметьте приход на месте.", "No estás cerca del local. Ficha la entrada en el local.", "Non sei vicino alla sede. Timbra l'entrata in sede."],
  ["Mekâna yakın değilsiniz. Mesaiyi mekânda bitirin.", "You're not near the venue. Clock out at the venue.", "Sie sind nicht am Standort. Stempeln Sie am Standort aus.", "Вы не рядом с местом. Отметьте уход на месте.", "No estás cerca del local. Ficha la salida en el local.", "Non sei vicino alla sede. Timbra l'uscita in sede."],
  ["Konum alınamadı. Konum iznini verin.", "Couldn't get location. Please allow location access.", "Standort konnte nicht ermittelt werden. Bitte Standortzugriff erlauben.", "Не удалось получить локацию. Разрешите доступ к геолокации.", "No se pudo obtener la ubicación. Permite el acceso a la ubicación.", "Impossibile ottenere la posizione. Consenti l'accesso alla posizione."],
  ["Cihaz konum (GPS) desteklemiyor.", "This device doesn't support location (GPS).", "Dieses Gerät unterstützt keine Standortbestimmung (GPS).", "Устройство не поддерживает геолокацию (GPS).", "Este dispositivo no admite ubicación (GPS).", "Questo dispositivo non supporta la posizione (GPS)."],
  ["Konum alınamadı. Konum iznini verdiğinizden emin olun.", "Couldn't get location. Make sure you've granted location permission.", "Standort konnte nicht ermittelt werden. Stellen Sie sicher, dass Sie die Standortberechtigung erteilt haben.", "Не удалось получить локацию. Убедитесь, что вы разрешили доступ к геолокации.", "No se pudo obtener la ubicación. Asegúrate de haber concedido el permiso de ubicación.", "Impossibile ottenere la posizione. Assicurati di aver concesso il permesso di posizione."],
  ["Yönetici bitirdi", "Ended by manager", "Vom Manager beendet", "Завершено руководителем", "Finalizado por el gerente", "Terminato dal responsabile"],
  ["Vardiya farkı", "Shift difference", "Schichtdifferenz", "Разница со сменой", "Diferencia de turno", "Differenza turno"],
  ["{name} adlı personelin mesaisini siz bitiriyorsunuz. Onaylıyor musunuz?", "You're ending {name}'s shift. Confirm?", "Sie beenden die Schicht von {name}. Bestätigen?", "Вы завершаете смену сотрудника {name}. Подтвердить?", "Vas a finalizar el turno de {name}. ¿Confirmar?", "Stai terminando il turno di {name}. Confermi?"],
  ["Demo süreniz doldu", "Your demo has ended", "Ihre Demo ist abgelaufen", "Демо-период закончился", "Tu demo ha terminado", "La demo è terminata"],
  ["7 günlük ücretsiz demo sona erdi.", "Your 7-day free demo has ended.", "Ihre 7-tägige kostenlose Demo ist abgelaufen.", "7-дневный бесплатный демо-период закончился.", "Tu demo gratuita de 7 días ha terminado.", "La demo gratuita di 7 giorni è terminata."],
  ["Devam etmek için aşağıdan ilgi talebi gönderin.", "To continue, send an interest request below.", "Senden Sie unten eine Anfrage, um fortzufahren.", "Чтобы продолжить, отправьте заявку ниже.", "Para continuar, envía una solicitud abajo.", "Per continuare, invia una richiesta qui sotto."],
  ["Devam için işletme yöneticinizle görüşün.", "To continue, contact your business manager.", "Wenden Sie sich an Ihren Betriebsleiter, um fortzufahren.", "Для продолжения обратитесь к руководителю.", "Para continuar, contacta con el gerente.", "Per continuare, contatta il responsabile."],
  ["📩 Devam etmek için ilgi talebi gönderin", "📩 Send an interest request to continue", "📩 Anfrage senden, um fortzufahren", "📩 Отправьте заявку, чтобы продолжить", "📩 Envía una solicitud para continuar", "📩 Invia una richiesta per continuare"],
  ["Talebinizi bırakın; size uygun planla en kısa sürede dönüş yapalım. Verileriniz güvende, silinmez.", "Leave your request; we'll get back to you soon with a suitable plan. Your data is safe and won't be deleted.", "Hinterlassen Sie Ihre Anfrage; wir melden uns bald mit einem passenden Plan. Ihre Daten sind sicher und werden nicht gelöscht.", "Оставьте заявку; мы скоро свяжемся с подходящим планом. Ваши данные в безопасности и не удаляются.", "Deja tu solicitud; te contactaremos pronto con un plan adecuado. Tus datos están seguros y no se borran.", "Lascia la tua richiesta; ti ricontatteremo presto con un piano adatto. I tuoi dati sono al sicuro e non vengono cancellati."],
  ["Talebi Gönder", "Send request", "Anfrage senden", "Отправить заявку", "Enviar solicitud", "Invia richiesta"],
  ["İşletme adı", "Business name", "Firmenname", "Название компании", "Nombre del negocio", "Nome dell'attività"],
  ["🎁 7 gün ücretsiz deneme · kredi kartı gerekmez", "🎁 7-day free trial · no credit card", "🎁 7 Tage kostenlos testen · keine Kreditkarte", "🎁 7 дней бесплатно · без карты", "🎁 7 días gratis · sin tarjeta", "🎁 7 giorni gratis · senza carta"],
  ["Evet, 7 gün boyunca tüm özellikleri ücretsiz deneyebilirsiniz; kredi kartı gerekmez. Ücretli paketler çok yakında.", "Yes, you can try all features free for 7 days; no credit card required. Paid plans are coming soon.", "Ja, Sie können 7 Tage lang alle Funktionen kostenlos testen; keine Kreditkarte nötig. Kostenpflichtige Pakete kommen bald.", "Да, 7 дней можно бесплатно пользоваться всеми функциями; карта не нужна. Платные тарифы скоро.", "Sí, puedes probar todas las funciones gratis durante 7 días; sin tarjeta. Los planes de pago llegan pronto.", "Sì, puoi provare tutte le funzioni gratis per 7 giorni; senza carta. I piani a pagamento arrivano presto."],
  ["7 gün ücretsiz · kredi kartı yok · kurulum yok.", "7 days free · no credit card · no setup.", "7 Tage kostenlos · keine Kreditkarte · keine Einrichtung.", "7 дней бесплатно · без карты · без установки.", "7 días gratis · sin tarjeta · sin instalación.", "7 giorni gratis · senza carta · senza installazione."],
  ["⏳ Demo süreniz doldu — devam etmek için ilgi talebi gönderin.", "⏳ Your demo has ended — send an interest request to continue.", "⏳ Ihre Demo ist abgelaufen — senden Sie eine Anfrage, um fortzufahren.", "⏳ Демо закончилось — отправьте заявку, чтобы продолжить.", "⏳ Tu demo terminó — envía una solicitud para continuar.", "⏳ La demo è terminata — invia una richiesta per continuare."],
  ["⏳ Ücretsiz demo: ", "⏳ Free demo: ", "⏳ Kostenlose Demo: ", "⏳ Бесплатное демо: ", "⏳ Demo gratis: ", "⏳ Demo gratuita: "],
  ["gün kaldı", "days left", "Tage übrig", "дн. осталось", "días restantes", "giorni rimasti"],
  ["Daha fazlası için Paketler'den ilgi talebi gönderin.", "For more, send an interest request from Packages.", "Für mehr senden Sie eine Anfrage unter Pakete.", "Для большего отправьте заявку в разделе Пакеты.", "Para más, envía una solicitud desde Paquetes.", "Per di più, invia una richiesta da Pacchetti."],
  ["İşletmeniz, mesai giriş/çıkış kaydının doğruluğu ve işyerinde bulunduğunuzun teyidi amacıyla, yalnızca giriş/çıkış yaptığınız anda konumunuzu bir kez alır. Sürekli veya canlı konum takibi yapılmaz; tam konumunuz saklanmaz, yalnızca işyerine yakın olup olmadığınız kaydedilir. Bu veriler yalnızca işvereniniz tarafından görülür ve üçüncü kişilerle paylaşılmaz. İşleme, çalışma ilişkisinin yürütülmesi kapsamında yapılır (KVKK). Haklarınız için işvereninize başvurabilirsiniz. Bu özellik isteğe bağlıdır.", "Your employer captures your location only once, at the moment you clock in/out, to verify attendance accuracy and your presence at the workplace. There is no continuous or live tracking; your exact location is not stored — only whether you were near the workplace. This data is seen only by your employer and is not shared with third parties. Processing is carried out within the scope of the employment relationship. For your rights, contact your employer. This feature is optional.", "Ihr Arbeitgeber erfasst Ihren Standort nur einmal, beim Ein-/Ausstempeln, um die Richtigkeit der Anwesenheit und Ihre Präsenz am Arbeitsplatz zu bestätigen. Keine kontinuierliche oder Live-Verfolgung; Ihr genauer Standort wird nicht gespeichert — nur ob Sie in der Nähe waren. Diese Daten sieht nur Ihr Arbeitgeber und werden nicht an Dritte weitergegeben. Die Verarbeitung erfolgt im Rahmen des Arbeitsverhältnisses. Für Ihre Rechte wenden Sie sich an Ihren Arbeitgeber. Diese Funktion ist optional.", "Ваш работодатель фиксирует местоположение только один раз, в момент отметки прихода/ухода, чтобы подтвердить точность учёта и присутствие на рабочем месте. Постоянного или живого отслеживания нет; точное местоположение не сохраняется — только факт близости к месту работы. Эти данные видит только работодатель и не передаёт третьим лицам. Обработка ведётся в рамках трудовых отношений. По правам обращайтесь к работодателю. Функция необязательна.", "Su empleador capta su ubicación solo una vez, al fichar entrada/salida, para verificar la exactitud de la asistencia y su presencia en el lugar de trabajo. No hay seguimiento continuo ni en vivo; no se guarda su ubicación exacta, solo si estaba cerca del trabajo. Estos datos solo los ve su empleador y no se comparten con terceros. El tratamiento se realiza en el marco de la relación laboral. Para sus derechos, contacte con su empleador. Esta función es opcional.", "Il datore di lavoro rileva la posizione solo una volta, al momento della timbratura, per verificare l'accuratezza delle presenze e la presenza sul luogo di lavoro. Nessun tracciamento continuo o in tempo reale; la posizione esatta non viene salvata, solo se eri nelle vicinanze. Questi dati sono visti solo dal datore di lavoro e non condivisi con terzi. Il trattamento avviene nell'ambito del rapporto di lavoro. Per i tuoi diritti, contatta il datore di lavoro. Funzione opzionale."],
  ...
  ["Bu ay", "This month", "Dieser Monat", "Этот месяц", "Este mes", "Questo mese"],
  ["Tümü", "All", "Alle", "Все", "Todos", "Tutti"],
  ["Kişi bazlı özet", "Per-person summary", "Zusammenfassung pro Person", "Сводка по сотрудникам", "Resumen por persona", "Riepilogo per persona"],
  ["Bu aralıkta tamamlanmış mesai yok.", "No completed shifts in this range.", "Keine abgeschlossenen Schichten in diesem Zeitraum.", "Нет завершённых смен за этот период.", "Sin turnos completados en este rango.", "Nessun turno completato in questo intervallo."],
